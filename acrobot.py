...
SYSTEM_EN = (
    "Your name is AcroBot 2.2. You are the official AI assistant of Acropolis College. "
...
SYSTEM_HI = (
    "Aapka naam AcroBot 2.2 hai. Aap Acropolis College ke official AI assistant hain. "
    ...
    with sd.InputStream(
        ...
        while True:
            ...
            audio_chunk = np.where(
                np.abs(audio_chunk) < NOISE_FLOOR,
                0,
                audio_chunk
            )
    ...
    try:
        while True:
            ...
            if state == State.SPEAKING:
                ...
                interrupted_audio = speak(reply, lang)

                # User interrupted while bot was speaking
